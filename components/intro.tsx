  ...
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
      ...
      >
        ...
        <a
          className="bg-white text-gray-700 p-4 flex items-center gap-2 rounded-full outline-none focus:scale-[1.15] hover:scale-[1.15]  active:scale-105 transition cursor-pointer border hover:text-gray-950  border-black/10"
          href="//linkedin.com"
          target="_blank"
        >
          <BsLinkedin />
